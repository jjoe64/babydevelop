...
*/
/*************************************************************************
 * $Id: kled.h,v 1.29 2003/11/05 15:10:13 rdale Exp $
 *************************************************************************/
...
public:
   ...
   * @short Constructor
   */
  BLed(const QColor &col, QWidget *parent=0);
   ...
   * @short Constructor
   */
  BLed(const QColor& col, BLed::State state, BLed::Look look, BLed::Shape shape, QWidget *parent=0);
   ...
   */
  void toggleState();//ufg// KDE_DEPRECATED;

  /**
   * Set the color of the widget.
   * The Color is shown with the BLed::On state.
   * The BLed::Off state is shown with QColor.dark() method
   *
