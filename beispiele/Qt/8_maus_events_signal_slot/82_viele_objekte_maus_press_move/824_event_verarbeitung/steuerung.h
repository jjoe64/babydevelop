...
private:
   ...
   int maus_y;
   int erzeugeNr;   //Nummer zu erzeugendes Bild
   int alleErzeugt;
   int lastVerschiebe;
...
private slots:
   ...
   void verschiebe(int, int, int);    //MausBewegung auf Bild in steuerung verarbeiten
   void mausKlickVerarbeitung(int);   //MausKlick auf Bild in steuerung verarbeiten
