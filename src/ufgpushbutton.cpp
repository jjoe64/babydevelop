...
/* Konstruktor */
UFGPushButton::UFGPushButton(QWidget *parent,const int nummer, QString s) : QPushButton(parent), UFGbasis()
{
   objektNummer=nummer;

   objektTyp=2;   // 1=QLabel, 2=QPushButton, 3=QLineEdit, 4=BLed
   this->setText(s);
...
// Destruktor
//------------
UFGPushButton::~UFGPushButton()
{
}


//----------------------------------------------------
void UFGPushButton::mousePressEvent( QMouseEvent* e )
{
...
//---------------------------------------------------
void UFGPushButton::mouseMoveEvent( QMouseEvent* e )
{
   if(aktion>0)
   {
...
//------------------------------------------------------
void UFGPushButton::mouseReleaseEvent( QMouseEvent* e )
{
   aktion=0;
}
